                ...
                <table id="dataTable" class="table table-striped table-hover table-condensed table-bordered">
                    ...
                    @foreach($table as $row)
                        <tr>
                            ...
                            <td class="text-right"><a href="{{action('Product\ProductCategoryController@del', ['id' => $row->categoryID])}}" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
